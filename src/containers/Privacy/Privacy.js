...
export default () => (
  <div>
    ...
    <p>
      ...
      "User") of the http://www.shuddhifund.org website ("Site").
    </p>
    <h3>Personal identification information</h3>
    <p>
      We may collect personal identification information from Users in a variety
      of ways, including, but not limited to, when Users visit our site, fill
      ...
      appropriate, name, email address. Users may, however, visit our Site
      ...
      always refuse to supply personally identification information, except that
    ...
    <p>
      Shuddhi Fund may collect and use Users personal information for the
      following purposes:
    </p>
    <ul>
      <li>
    ...
    <p>
      Shuddhi Fund has the discretion to update this privacy policy at any time
      without notice. We encourage Users to frequently check this page for any
    ...
    <p>
      ...
      your acceptance of those changes. This privacy policy was built{" "}
      <a
        href="http://privacypolicies.com/"
        target="_blank"
