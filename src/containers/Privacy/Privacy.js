...
export default () => (
  <div>
    <Head>
      <title>Privacy | Shuddhi Fund</title>
    </Head>
    ...
    <p>
      This Privacy Policy governs the manner in which Shuddhi Fund collects, uses, maintains and
      discloses information collected from users (each, a "User") of the http://www.shuddhifund.org
      website ("Site").
    </p>
    <h3>Personal identification information</h3>
    <p>
      We may collect personal identification information from Users in a variety of ways, including,
      but not limited to, when Users visit our site, fill out a form, and in connection with other
      ...
      will collect personal identification information from Users only if they voluntarily submit
    ...
    <p>Shuddhi Fund may collect and use Users personal information for the following purposes:</p>
    <ul>
      <li>
    ...
    <p>
      Shuddhi Fund has the discretion to update this privacy policy at any time without notice. We
    ...
    <p>
      ...
      changes to this policy will be deemed your acceptance of those changes. This privacy policy
      was built{' '}
      <a href="http://privacypolicies.com/" target="_blank" rel="noopener noreferrer">
        with the www.PrivacyPolicies.com generator
      </a>
      .
    </p>
    <h3>Contacting us</h3>
    <p>
      ...
      dealings with this site, please <Link to="/contact">contact us</Link>.
    </p>
    <p>This document was last updated on June 13, 2017</p>
  </div>
)
